...
public class SwitchMenu extends javax.swing.JFrame {
    ...
    private void downloadAllActionPerformed(java.awt.event.ActionEvent evt) {                                            
        downloadAll.setEnabled(false);
        jButton1.setEnabled(false);
        switchButton.setEnabled(false);
        n3dsButton.setEnabled(false);
    ...
    private void n3dsButtonActionPerformed(java.awt.event.ActionEvent evt) {                                           
        apps = AppsManagement.addCTRApps();
        addElements();
        updateVersionsFromGitHub(this::onVersionsLoaded);
    }                                          

    private void WiiActionPerformed(java.awt.event.ActionEvent evt) {                                    
        apps = AppsManagement.addDolphinApps();
        addElements();
        updateVersionsFromGitHub(this::onVersionsLoaded);
    }                                   

    private void WiiUActionPerformed(java.awt.event.ActionEvent evt) {                                     
    ...
    private void vWiiActionPerformed(java.awt.event.ActionEvent evt) {                                     
